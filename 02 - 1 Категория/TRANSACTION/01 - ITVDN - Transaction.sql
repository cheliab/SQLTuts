...
values
(1, '1990-05-31', 76, 170, 'Россия', 'Москва', 'Москва'),
(2, '1991-04-20', 70, 182, 'Россия', 'Санкт-Питербург', 'Москва'),
(3, '1989-03-31', 68, 176, 'Украина', 'Киев', 'Киев'),
(4, '1995-04-30', 80, 178, 'Мексика', 'Мехико', 'Мехико'),
(5, '1992-01-20', 82, 180, 'США', 'Нью-Йорк', 'Лос-Анджелес')

-------------------------------------------

-- Добавляем ограничение, чтобы вызвать ошибку при добавлении новой записи через процедуру
...
-- Вызов процедуры с дублем по дате (возникнет откат с выводом ошибки)

exec spAddPlayer @FirstName = 'Павел', @LastName = 'Доросевич', @BirthDate = '1990-05-31'

-- Проверка (данные в таблицы не добавились)
select * from Players
